...
// you will probably want to do some processing here such as logging the purchase in a database etc
	...
	mysqli_query("UPDATE member SET verification = 'yes' WHERE memberid = '$item_number' ")or die(mysqli_error());
			mysqli_query("INSERT INTO login_info(memberid,browser) VALUES('$item_number',1)")or die(mysqli_error());
