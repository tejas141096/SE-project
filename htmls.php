<?php
	function headhtml(){
		echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			...
			<head>
			<title>BOMBAY COMMODITY EXCHANGE</title>
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="logo"> <a href="#"><img src="images/bce.png" alt="" border="0" width="237" height="140" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/bce.png" alt="" width="170" height="49"/> </div>
				<div class="center_footer"> BOMBAY COMMODITY EXCHANGE. <br />
				   </div>
